...
class TakeASip:
    def __init__(self,host='localhost',bindingip='',externalip=None,localport=5060,port=5060,
                 ...
                 sessionpath=None,compact=False,socktimeout=5,initialcheck=True,
                 disableack=False,maxlastrecvtime=5, domain=None, printdebug=False,
                 ):
        ...
        while 1:
            ...
            if r:
                ...
                if timediff > self.maxlastrecvtime:
                    self.nomore = True
                    self.log.warn('It has been %s seconds since we last received a response - stopping %s' % (timediff , self.dsthost) )
                    break
