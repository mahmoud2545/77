...
def numericbrute(rangelist,zeropadding=0,template=None,defaults=True,staticbrute=[]):
...
def makeRequest(
                ...
                ,contact='sip:100@46.166.160.136',accept='application/sdp',contentlength=None,
